...
function DestinationCard({ id, country_or_territory, continent, flag_url }) {
  ...
  return (
    <div className="p-6 max-w-sm bg-green-200 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto">
      ...
      <div className="flex flex-wrap gap-2">
        <Button onClick={() => handleDestCardClick(id)} gradientMonochrome="cyan">
          Reviews
        </Button>
      </div>
    </div>
